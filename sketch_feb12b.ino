...
char ssid[] = "Abhimat PC";                               // Enter your WiFi SSID (router name)
char pass[] = "aabhimatg";                             // Enter your WiFi router password
unsigned long myChannelNumber = 989515;                 // Enter your Thingspeak Channel Number
const char * myWriteAPIKey = "MF7XXGK5H20DLDP4";        // Enter your ThingSpeak API Key
